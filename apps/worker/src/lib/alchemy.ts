...
async function alchemyRequest<T>(method: string, params: unknown[], env: Env): Promise<T> {
...
function resolveType(raw: AlchemyTransferRaw, address: string): WhaleTxDTO['type'] {
