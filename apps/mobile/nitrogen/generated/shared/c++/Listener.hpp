...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::lockfi::securekeymanager::Listener> final {
    static inline margelo::nitro::lockfi::securekeymanager::Listener fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::lockfi::securekeymanager::Listener(
        JSIConverter<std::function<void()>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "remove")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::lockfi::securekeymanager::Listener& arg) {
