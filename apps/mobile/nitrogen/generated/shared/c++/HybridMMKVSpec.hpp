...
namespace margelo::nitro::lockfi::securekeymanager { struct Listener; }
...
#include <functional>
#include <memory>
#include <NitroMmkv/HybridMMKVSpec.hpp>
...
namespace margelo::nitro::mmkv {
  ...
  class HybridMMKVSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual double importAllFrom(const std::shared_ptr<margelo::nitro::mmkv::HybridMMKVSpec>& other) = 0;
