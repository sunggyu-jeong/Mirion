...
namespace margelo::nitro::lockfi::securekeymanager { enum class EncryptionType; }
// Forward declaration of `Mode` to properly resolve imports.
namespace margelo::nitro::lockfi::securekeymanager { enum class Mode; }
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::lockfi::securekeymanager::Configuration> final {
    static inline margelo::nitro::lockfi::securekeymanager::Configuration fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::lockfi::securekeymanager::Configuration(
        ...
        JSIConverter<std::optional<margelo::nitro::lockfi::securekeymanager::EncryptionType>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "encryptionType"))),
        JSIConverter<std::optional<margelo::nitro::lockfi::securekeymanager::Mode>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "mode"))),
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "readOnly")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::lockfi::securekeymanager::Configuration& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "encryptionType"), JSIConverter<std::optional<margelo::nitro::lockfi::securekeymanager::EncryptionType>>::toJSI(runtime, arg.encryptionType));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "mode"), JSIConverter<std::optional<margelo::nitro::lockfi::securekeymanager::Mode>>::toJSI(runtime, arg.mode));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<margelo::nitro::lockfi::securekeymanager::EncryptionType>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "encryptionType")))) return false;
      if (!JSIConverter<std::optional<margelo::nitro::lockfi::securekeymanager::Mode>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "mode")))) return false;
