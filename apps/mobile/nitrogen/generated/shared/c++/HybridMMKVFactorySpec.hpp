...
namespace margelo::nitro::lockfi::securekeymanager { struct Configuration; }
...
namespace margelo::nitro::mmkv {
  ...
  class HybridMMKVFactorySpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<margelo::nitro::mmkv::HybridMMKVSpec> createMMKV(const Configuration& configuration) = 0;
