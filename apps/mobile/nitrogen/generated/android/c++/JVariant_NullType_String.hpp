...
namespace margelo::nitro::lockfi::securekeymanager {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/lockfi/securekeymanager/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/lockfi/securekeymanager/Variant_NullType_String$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/lockfi/securekeymanager/Variant_NullType_String$Second;";
