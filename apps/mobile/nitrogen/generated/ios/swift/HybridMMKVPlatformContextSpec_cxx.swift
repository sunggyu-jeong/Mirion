...
open class HybridMMKVPlatformContextSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__mmkv__HybridMMKVPlatformContextSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::mmkv::HybridMMKVPlatformContextSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__mmkv__HybridMMKVPlatformContextSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__mmkv__HybridMMKVPlatformContextSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__mmkv__HybridMMKVPlatformContextSpec_(newCxxPart)
      return newCxxPart
    }
  }
